                    ...
                    <div class="intro-text">
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="text" class="form-control" placeholder="Nomor Meja" id="no_meja" required data-validation-required-message="Isikan Nomor Meja" name="no_meja">
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="text" class="form-control" placeholder="Nama" id="nama_pemesan" name="nama_pemesan" required data-validation-required-message="Isikan Nama">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="date" class="form-control" placeholder="Tanggal" id="tanggal" name="tanggal" required data-validation-required-message="Isikan Tanggal" >
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <?php foreach ($makanan as $key) { ?>
                                    <input type="checkbox" class="form-control" name="nama_makanan[]" value="<?php echo $key['nama_makanan'] ?>" ><h5><?php echo $key['nama_makanan'] ?></h5>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <?php foreach ($minuman as $key) { ?>
                                    <input type="checkbox" class="form-control" name="nama_minuman[]" value="<?php echo $key['nama_minuman'] ?>" >
                                    <h5><?php echo $key['nama_minuman'] ?></h5>
