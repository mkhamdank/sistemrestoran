...
<h1><font style="color: red">Suskes Hapus Data</font></h1>
    <p>
      <?php
        // echo anchor('Restoran_controller/delete_minuman/'.$this->uri->segment(3),'
        // <button type="button" class="btn btn-success">Hapus Menu Lagi</button>');
        // echo "&nbsp";
