...
<?php echo form_open_multipart('restoran_controller/create_makanan');?>
    <legend><h2><b>Tambah Menu Makanan</b></h2></legend>
    <?php echo validation_errors();?>
    <div class="form-group">
    <?php foreach ($makanan as $key):
      ?>
      <?php $id_makanan = $key['id_makanan'];?>
    <?php endforeach ?>
      <label>ID</label>
      <input type="text" class="form-control" name="id_makanan" id="nama_makanan" value="<?php
      if (ISSET($id_makanan)) {
        echo $id_makanan+1;
      }
      else{
      ...
      <input type="text" class="form-control" name="jenis_makanan" id="jenis_makanan">
      <label>Harga</label>
      <input type="text" class="form-control" name="harga_makanan" id="harga_makanan">
      <label>Stok</label>
      <input type="text" class="form-control" name="stok_makanan" id="stok_makanan">
      <label>Gambar</label>
