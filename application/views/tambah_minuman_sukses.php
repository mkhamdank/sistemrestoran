...
<div class="container">
  ...
  <h1><font style="color: red">Suskes Simpan Data</font></h1>
    <p>
      <?php
        // echo anchor('restoran_controller/create_minuman','<button type="button" class="btn btn-success">Masukkan Menu Lagi</button>');
        // echo "&nbsp";
