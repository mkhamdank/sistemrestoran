...
<div class="container">
  ...
  <?php echo form_open_multipart('restoran_controller/edit_minuman/'.$this->uri->segment(3).'/'.$this->uri->segment(4));?>
    <legend><h2><b>Edit Menu Minuman</b></h2></legend>
...
foreach ($minuman->result() as $key){
  ?>
      <label>ID</label>
      <input type="text" class="form-control" name="id_minuman" id="nama_minuman" placeholder="Masukkan ID Minuman" value="<?php echo $key->id_minuman; ?>"></input>
  <?php
}
    ?>
...
foreach ($minuman->result() as $key){
  ?>
      ...
      <input type="text" class="form-control" name="nama_minuman" id="nama_minuman" placeholder="Masukkan Nama Minuman" value="<?php echo $key->nama_minuman; ?>"></input>
  <?php
}
    ?>
...
foreach ($minuman->result() as $key){
  ?>
      <label>Harga</label>
      <input type="text" class="form-control" name="harga_minuman" id="harga_minuman" placeholder="Masukkan Harga Minuman" value="<?php echo $key->harga_minuman; ?>"></input>
  <?php
}
    ?>
...
foreach ($minuman->result() as $key){
  ?>
      <label>Stok Minuman</label>
      <input type="text" class="form-control" name="stok_minuman" id="stok_minuman" placeholder="Masukkan Stok Minuman" value="<?php echo $key->stok_minuman; ?>"></input>
  <?php
}
    ?>
    <?php
foreach ($minuman->result() as $key){
  ?>
      ...
      <img width="70" src="<?=base_url("assets/uploads")."/".$key->gmbr?>">
