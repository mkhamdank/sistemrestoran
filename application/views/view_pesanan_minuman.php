  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo $key->pesanan_mnm?></td>
          <td><?php echo $key->jml_mnm?></td>
          <td><?php echo $key->harga?></td>
          
          <td><a href="<?php echo site_url('restoran_controller/pembayaranMinuman/'.$key->id_pemesanan_min);?>" class="btn btn-success">Bayarkan</a></td>
        </tr>
        <?php } ?>
      </tbody>
