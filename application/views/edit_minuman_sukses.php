...
<h1><font style="color: red">Suskes Edit Data Minuman</font></h1>
    <p>
      <?php
        // echo anchor('Restoran_controller/update_minuman/'. $this->uri->segment(3),'<button type="button" class="btn btn-success">Edit Menu Lagi</button>');
        // echo "&nbsp";
        echo anchor('restoran_controller/minuman','<button type="button" class="btn btn-success">Lihat Menu</button>');
      ?>
    </p>
    </div>
    </div>
