        ...
        <table class="table table-bordered text-center" id='example'>
          ...
          <?php foreach ($array_makan as $key) {?>
            <tr>
              ...
              <td><?php echo $key['jenis_makanan']?></td>
              <td><?php echo $key['harga_makanan']?></td>
              <td><?php echo $key['stok_makanan']?></td>
              <td><img width="100px" src="<?=base_url("assets/uploads")."/".$key['gambar'] ?>"></td>
              <td><a href="<?php echo site_url('restoran_controller/edit_makanan/'.$key['id_makanan'].'/'.$key['gambar']);?>" class="btn btn-success">Edit</a>&nbsp&nbsp&nbsp<a href="<?php echo site_url('restoran_controller/delete_makanan/'.$key['id_makanan'].'/'.$key['gambar']);?>" class="btn btn-danger">Hapus</a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
