            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="intro-text">
                        <h1 class="name">PEMESANAN<br>ERROR</h1>
                        <hr class="star-light">
                        <div class="row">
                            <div class="col-lg-8 col-lg-offset-2">
                                <h3>Makanan atau Minuman tidak bisa dipesan karena stok tidak ada atau kurang dari yang Anda pesan.</h3> <br>
                                <a class="btn btn-primary" href="<?php echo site_url('restoran_controller/menu') ?>">LIHAT MENU LAGI</a>
                            </div>
                        </div>
                    </div>
                </div>
