...
<div class="container">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <tbody>
        ...
        <tr>
          <td><?php echo $key['nama_minuman']?></td>
          <td><?php echo $key['harga_minuman']?></td>
          <td><?php echo $key['stok_minuman']?></td>
          <td><img width="100px" src="<?=base_url("assets/uploads")."/".$key['gmbr'] ?>"></td>
          <td><a href="<?php echo site_url('restoran_controller/edit_minuman/'.$key['id_minuman'].'/'.$key['gmbr']);?>" class="btn btn-success">Edit</a>&nbsp&nbsp&nbsp<a href="<?php echo site_url('restoran_controller/delete_minuman/'.$key['id_minuman'].'/'.$key['gmbr']);?>" class="btn btn-danger">Hapus</a></td>
        </tr>
        <?php } ?>
      </tbody>
